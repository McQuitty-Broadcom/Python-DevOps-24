...
- Your login: is mfwsuser24@demo.broadcom.com
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS24 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS24 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST024.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST024.MARBLES.JCL(MARBCOPY)" --vasc`
