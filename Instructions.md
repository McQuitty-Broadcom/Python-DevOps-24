...
- Submit JCL to perform the Bind & Grant
  - `zowe jobs submit data-set "CUST024.MARBLES.JCL(MARBIND)" --view-all-spool-content`
    - This function runs the command and returns all the job content
  - Alternative approach
    - `zowe jobs submit data-set "CUST024.MARBLES.JCL(MARBIND)"`
...
- Run the command manually:
  - `zowe console issue command "F CICSTRN1,_CICSTRANS_ CRE _COLOR_ 1 2" --console-name CUST024`
    - Did you get a +SUCCESS message?
  - Check the database
    - `zowe jobs submit ds "CUST024.MARBLES.JCL(MARBDB2)" --vasc`
