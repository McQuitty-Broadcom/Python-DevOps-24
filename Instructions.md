...
- Your login: is _SNCUST024
- The password is _SNCUST024
...
- Your userid is CUST024.
- Your password _MFCUST024.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate element DOGGOS24 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate element DOGGOS24 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset _MFCUST024.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST024.PUBLIC.JCL(NDRUNDOG)" --vasc`
...
Username: _JENKINSCUST024
Password: Mfuser24@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-24.git`
